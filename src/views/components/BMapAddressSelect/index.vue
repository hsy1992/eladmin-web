<template>
  <el-dialog title="位置选择" :visible.sync="openMap" width="900px" append-to-body>
        ...
        <el-col :span="14">
          <el-form-item label="当前地址">
            <el-input placeholder="请输入内容" v-model="addressInfo.address">
              <template slot="prepend">{{ addressInfo.province }}{{ addressInfo.city }}{{ addressInfo.district
              }}</template>
            </el-input>
          </el-form-item>
        </el-col>
    ...
    <div id="baidu-map-container" style="width: 100%; height: 400px;">
      <baidu-map class="bm-view" :center="{ lng: 126.543911, lat: 45.808622 }" :zoom="14" :scroll-wheel-zoom="true"
        @ready="mapReady">
      </baidu-map>
    </div>
...
<script>
// import BaiduMap from 'vue-baidu-map/components/map/Map.vue' 1jWhMHcSX1PX2R5x5z2hCGq5ELQCRroY
...
export default {
  ...
  methods: {
    ...
    getClickInfo(e) {
      ...
      var marker = new BMapMarker(clickpt); // 创建标注
    ...
    initBaiduMap() {
      ...
      //   var point = new BMap.Point(126.543911, 45.808622); // 设置中心点坐标
