  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="销售价">
            <el-input v-model="form.salesPrice" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="计价方式">
            <el-input v-model="form.valuationMethod" style="width: 370px;" />
          </el-form-item>
        </el-form>
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="checkPer(['admin','tsProductBaseInfo:edit','tsProductBaseInfo:del'])" label="操作" width="150px" align="center">
...
const defaultForm = { createdBy: null, createdTime: null, updatedBy: null, updatedTime: null, isDel: null, code: null, name: null, shortName: null, model: null, size: null, cateName: null, brandName: null, supplier: null, buyPrice: null, salesPrice: null, valuationMethod: null, id: null }
export default {
